    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-lg-center">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="Dashboard.php#services">Services</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="Dashboard.php#gallery">Gallery</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="Dashboard.php#testimoni">Testimoni</a>
                </li>
