...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@500;600;700&family=Poppins:wght@300;400;500&display=swap"
    rel="stylesheet">
        ...
        <div class="col-md-4">
          <div class="card package-card h-100">
            <div class="card-body text-center">
              ...
              <h6 class="fw-bold mt-2">Makeup & Attire, Photo & Videographer, Dekorasi, MC, dan
                Entertaiment</h6>
              <p class="price">Rp 25.000.000</p>
              <a href="#" class="btn btn-outline-primary" data-bs-toggle="modal"
                data-bs-target="#modalPaket" data-title="Detail Paket 1"
        ...
        <div class="col-md-4">
          <div class="card package-card h-100">
            <div class="card-body text-center">
              ...
              <h6 class="fw-bold mt-2">Makeup & Attire, Photo & Videographer, Wedding Organizer, Dekorasi,
                MC, Entertaiment, dan Upacara Adat</h6>
              <p class="price">Rp 36.000.000</p>
              <a href="#" class="btn btn-outline-primary" data-bs-toggle="modal"
                data-bs-target="#modalPaket" data-title="Detail Paket 2"
        ...
        <div class="col-md-4">
          <div class="card package-card h-100">
            <div class="card-body text-center">
              ...
              <h6 class="fw-bold mt-2">Makeup & Attire, Photo & Videographer, Upacara Adat, Dekorasi, MC,
                Entertaiment, Siraman, Pre-Wedding, dan Wedding Organizer</h6>
              <p class="price">Rp 40.000.000</p>
              <a href="#" class="btn btn-outline-primary" data-bs-toggle="modal"
                data-bs-target="#modalPaket" data-title="Detail Paket 3"
        ...
        <div class="col-md-4">
          <div class="card package-card h-100">
            <div class="card-body text-center">
              ...
              <h6 class="fw-bold mt-2">Makeup & Attire, Photo & Videographer, Upacara Adat, Dekorasi, MC,
                Entertaiment, Siraman, Pre-Wedding, Wedding Organizer, dan Catering</h6>
              <p class="price">Rp 70.000.000</p>
              <a href="#" class="btn btn-outline-primary" data-bs-toggle="modal"
                data-bs-target="#modalPaket" data-title="Detail Paket 4"
        ...
        <div class="col-md-4">
          <div class="card package-card h-100">
            <div class="card-body text-center">
              ...
              <a href="#" class="btn btn-outline-primary" data-bs-toggle="modal"
                data-bs-target="#modalPaket" data-title="Detail Paket 5"
        ...
        <div class="col-md-4">
          <div class="card package-card h-100">
            <div class="card-body text-center">
              ...
              <h6 class="fw-bold mt-2">Makeup & Attire, Photo & Videographer, Dekorasi, MC, venue,
                Catering, dan Entertaiment</h6>
              <p class="price">Rp 50.000.000</p>
              <a href="#" class="btn btn-outline-primary" data-bs-toggle="modal"
                data-bs-target="#modalPaket" data-title="Detail Paket 500"
        ...
        <div class="col-md-4">
          <div class="card package-card h-100">
            <div class="card-body text-center">
              ...
              <h6 class="fw-bold mt-2">Makeup & Attire, Photo & Videographer, Dekorasi, MC, Venue, dan
                Catering</h6>
              <p class="price">Rp 25.000.000</p>
              <a href="#" class="btn btn-outline-primary" data-bs-toggle="modal"
                data-bs-target="#modalPaket" data-title="Detail Paket Intimate 1"
        ...
        <div class="col-md-4">
          <div class="card package-card h-100">
            <div class="card-body text-center">
              ...
              <a href="#" class="btn btn-outline-primary" data-bs-toggle="modal"
                data-bs-target="#modalPaket" data-title="Detail Paket Intimate 2"
        ...
        <div class="col-md-4">
          <div class="card package-card h-100">
            <div class="card-body text-center">
              ...
              <h6 class="fw-bold mt-2">Makeup & Attire, Photo & Videographer, Wedding Organizer, Dekorasi,
                MC, Venue, Catering, dan Entertaiment</h6>
              <p class="price">Rp 55.000.000</p>
              <a href="#" class="btn btn-outline-primary" data-bs-toggle="modal"
                data-bs-target="#modalPaket" data-title="Detail Paket Venue"
